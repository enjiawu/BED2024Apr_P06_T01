...
class User{
    ...
    static async getUsersWithPosts() {
        ...
        try{
            const sqlQuery = 'SELECT u.userId, u.username, p.postId, p.title, p.description FROM Users u LEFT JOIN UserCommunityPosts up ON up.userId = u.userId LEFT JOIN CommunityPosts p ON up.postId = p.postId ORDER BY u.username';
